            ...
            <div className='logInPageContainer'>
                ...
                <div className='logInRightSide'>
                    ...
                    <div style={{ display: 'flex', justifyContent: "flex-end", alignItems: "center" }}>
                        ...
                        <MyButton label='忘記密碼  ' className={'confirmationBtn buttonsHover loginFooterButtons'} />

                        <MyButton label='忘記用戶名 ' className={'confirmationBtn buttonsHover loginFooterButtons'} />

                        <MyButton label='免費註冊' className={'confirmationBtn buttonsHover loginFooterButtons'} />
