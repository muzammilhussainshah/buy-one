        ...
        <>
            ...
            <div className='createAddressSection fragHeading ' style={{ padding: '1vw' }}>
                ...
                <div className='myStoreImg'>
                    ...
                    {!edit && <div />}
                    {edit && <div style={{ height: '90%', marginRight: "1vw" }}><FaRegEdit className="edit-icon makeAnchr" /></div>}
                </div>
                ...
                <div style={{ display: 'flex', flex: 1, width: '100%' }}>
                    ...
                    <div className='emptyStoreLeftSide  '  >
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            EMPTY Online Store{edit && <FaRegEdit className="edit-icon makeAnchr" />}
                        </div>
                    ...
                    <div className='emptyStoreRightSide'>
                        <div className='createAddressSection starCardContainer' style={{ margin: '0px' }}>
                            ...
                            <div className='cartPaginationContainer  '>
                                ...
                                <div>
                                    <MyButton onClick={() => changePageHandle('previous')} label='上一頁'
                                    ...
                                    <MyButton onClick={() => changePageHandle('next')} label='下一頁'
                                        // className={'confirmationBtn confirmationBtnHover'}
